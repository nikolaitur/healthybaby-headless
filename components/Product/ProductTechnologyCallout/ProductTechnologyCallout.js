      ...
      <div className="product-technology-callout__container container">
        <div className="product-technology-callout__content">
          {content.fields?.subheader ? (
            <h6 className="product-technology-callout__subheader">
              {content.fields.subheader}
            </h6>
          ) : (
            ''
          ...
          {content.fields?.header ? (
            <div
              className="product-technology-callout__header"
          ...
          {content.fields?.copy ? (
            <h4 className="product-technology-callout__description large">
              {content.fields.copy}
            </h4>
          ) : (
            ''
        ...
        {content.fields?.sections ? (
          <div className="product-technology-callout__items">
            {content.fields.sections.map((item, index) => {
              return (
                <div
                  className={`product-technology-callout__item ${
                    item.fields.flipped == 'True' ? 'flipped' : ''
                  }`}
                  key={index}
                >

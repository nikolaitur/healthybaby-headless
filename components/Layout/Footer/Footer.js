        ...
        <div className="footer__container container">
          ...
          <div className="footer__nav">
            {mainNavigation.map((item, index) => (
              <div
                className="footer__wrapper footer__wrapper--main"
                key={index}
              >
                <div className="footer__title">{item.fields.title}</div>
          ...
          <div className="footer__copyright">
            ...
            <div className="footer__policy footer__policy--mobile">
              <Link href={policy[0].fields.url}>{policy[0].fields.title}</Link>
              <span>|</span>
              <Link href={policy[1].fields.url}>{policy[1].fields.title}</Link>
              <span>|</span>
              <Link href={policy[2].fields.url}>{policy[2].fields.title}</Link>
            </div>
          </div>
        </div>
